    ...
    return (
        <>
            <div className={`VideoCard ${props.currentVideoId === props.VideoCard_info.id ? 'CurrentPlayingVideo' : 'NotPlayingVideo'}`} id={props.VideoCard_info.id}>
                ...
                <img className="VideoCard--img" src={`${props.index <= 8 ? (`https://howard-brainflix-api.herokuapp.com/assets/image`+ props.index + `.jpeg`): (`https://howard-brainflix-api.herokuapp.com/assets/image8.jpeg`) }`} alt="Video Img"/>
